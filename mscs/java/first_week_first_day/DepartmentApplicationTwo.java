...
public class DepartmentApplicationTwo
   {
   public static void main(String[] args) throws IOException
      ...
      //  addPerson (this replaces the other three methods).
		...
		Person frankEnrik = new StaffStudent("Frank Enrik","472-3321",33,4050,3);
		Person EmmanuelEdorh = new StaffStudent("Emmanuel Edorh","476-7552",23,5500,4);
		Person AkosAbass = new StaffStudent("Akos Abass","472-8800",23,3600,3.1);
		dept.addPerson (frankEnrik);
		dept.addPerson(EmmanuelEdorh);
		dept.addPerson(AkosAbass);
...
However, this mistake below does show us How we could implement the code IF it was two-directional!  */
      ...
      /********************************************************/
		...
		maryJones.addCourse(cs240);
		maryJones.addCourse(cs450);
		leeJohnson.addCourse(cs301);
      ...
      while(true)
         ...
         putText("getTotalSalary, showAllMembers, unitsPerFaculty, listOfStudentsByFaculty or quit : ");
         int choice = getChar();
         switch(choice)
            {
            case 'g':
            ...
            case 'u':
               ...
               break;
            case 'l':
            	putText(" Enter the name of the faculty :");
            	String text = getString();
                dept.listOfStudentsByFaculty(text);
                break;
            case 'q': return;
            default:
